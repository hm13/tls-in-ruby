...
def invMixColumns()
  ...
  (0..3).each do |j|
    ...
    tmp[0][j] = mod011B(multPoly(0x0e, b0)) ^ mod011B(multPoly(0x0b, b1)) ^ mod011B(multPoly(0x0d, b2)) ^ mod011B(multPoly(0x09, b3))
    tmp[1][j] = mod011B(multPoly(0x09, b0)) ^ mod011B(multPoly(0x0e, b1)) ^ mod011B(multPoly(0x0b, b2)) ^ mod011B(multPoly(0x0d, b3))
    tmp[2][j] = mod011B(multPoly(0x0d, b0)) ^ mod011B(multPoly(0x09, b1)) ^ mod011B(multPoly(0x0e, b2)) ^ mod011B(multPoly(0x0b, b3))
    tmp[3][j] = mod011B(multPoly(0x0b, b0)) ^ mod011B(multPoly(0x0d, b1)) ^ mod011B(multPoly(0x09, b2)) ^ mod011B(multPoly(0x0e, b3))
  end
